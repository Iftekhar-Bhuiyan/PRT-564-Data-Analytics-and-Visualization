...
# Load the dataset
data = pd.read_csv('/Users/eshayathasan/Documents/Semester 2/Data Visualization/Assignment 2/retractions35215 (1) 8.51.43 PM.csv').sample(n=2000, random_state=42)
...
for kernel in kernels:
    ...
    print(f"Accuracy with PCA (no standardization): {accuracy}")
    print("\n" + "="*80 + "\n")